...
urlpatterns = [
    ...
    path('view-post/', CreatorPost.as_view(), name='view-post'),
    path('update-post/<int:pk>/', CreatorPost.as_view(), name='update-post'),
    path('delete-post/<int:pk>/', CreatorPost.as_view(), name='delete-post'),
